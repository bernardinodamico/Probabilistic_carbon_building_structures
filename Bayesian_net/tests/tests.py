...
class TestBuild_ProbTables(unittest.TestCase):
    ...
    def test_marginal_probs(self):
        ...
        self.assertEqual(dd, bench[key], 'marginal prob table error')
        ...
        for key in bench:
            self.assertEqual(round(mpt[key], 3), round(bench[key], 3), 'marginal prob table error')
    ...
    def test_joint_probs(self):
        ...
        for key in bench:
            self.assertEqual(round(mpt[key], 3), round(bench[key], 3), 'joint prob table error')
    ...
    def test_conditional_probs(self):
        ...
        for key in bench:
            self.assertEqual(round(mpt[key], 3), round(bench[key], 3), 'cond prob table error')
